...
{
    class CodeGenTemplateSession : ITextTemplatingSession
    {
        readonly Dictionary<string, object> session = new Dictionary<string, object>();
        readonly CodeGenTemplateGenerator codeGenTemplateGenerator;

        public CodeGenTemplateSession(CodeGenTemplateGenerator codeGenTemplateGenerator)
        {
            this.codeGenTemplateGenerator = codeGenTemplateGenerator;
        }
